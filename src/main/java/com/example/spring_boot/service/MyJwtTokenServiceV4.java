...
@Slf4j
@Service
public class MyJwtTokenServiceV4 {
    private final long JWT_EXPIRATION = 10500000L; // 1 day
    ...
    public Mono<String> generateTokenV4(JwtTokenRequest jwtTokenRequest) {
